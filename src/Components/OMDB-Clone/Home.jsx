...
import {DownloadForOfflineRounded, Search } from '@mui/icons-material';
        ...
        <div className='omdbsearchparent'>
            ...
            data.map((movie)=>(
                    <div className='omdbcards'>
                       ...
                       <button className='downloaddbtn1' onClick={() => handleDownload(movie.Poster)}><DownloadForOfflineRounded style={{fontSize:20,color:'white'}}/></button>
                    </div>
                ))
            ) }
            </div>
